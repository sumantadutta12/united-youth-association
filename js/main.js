$(function () {
    ...
    const aiHelpContent = {
        en: {
            ...
            donate: {
                tag: 'Donation suggestion',
                title: 'Support a focused community need',
                text: 'Choose a clear cause like school kits, food support, health awareness, or blood donation camp logistics. We will guide you with the current priority.',
            ...
            blood: {
                ...
                text: 'You can donate blood, register donors, share awareness, arrange transport, or help with on-ground coordination during the camp.',
                link: 'event.html',
    ...
    const homeTranslations = {
        en: {
            text: {
                ...
                '.navbar-nav .nav-item:eq(4) .nav-link': 'Volunteers',
                '.navbar-nav .nav-item:eq(5) .nav-link': 'Updates',
                ...
                '.banner_slider_item[style*="banner-10"] .banner_text p': 'Our team is still young, but our commitment is clear. Every donation goes toward practical needs like food, school supplies, basic care, and awareness programs.',
                ...
                '.category_item h3:eq(0)': 'Education',
                '.category_item h3:eq(1)': 'Medical Help',
                '.category_item h3:eq(2)': 'Environment',
                '.category_item h3:eq(3)': 'Healthy Foods',
                '.category_item h3:eq(4)': 'Financial Support',
                '.category_item h3:eq(5)': 'Awareness',
                '.category_item h3:eq(6)': 'Elder Care',
                ...
                '.ai_help_intro p': 'Choose what you want to do. The assistant will suggest the most useful next step for volunteering, donating, local support, or blood donation.',
                ...
                '.event_2 .wssus__event_item_2 .text p': 'Donate blood and help save lives through our community blood donation drive.',
                ...
                '.home_faq_intro': 'Clear answers for volunteers, donors, and community members who want to understand how we work.',
            ...
            buttons: {
                ...
                '.ai_help_options button[data-ai-help="donate"]': 'Donate',
            ...
            faq: [
                ...
                'Can I donate for a specific cause?',
            ...
            faqBody: [
                ...
                'Yes. You can support specific needs such as school kits, food support, health awareness, or blood donation camp arrangements. We keep the purpose clear before accepting support.',
        ...
        bn: {
            text: {
                ...
                '.category_item h3:eq(0)': 'শিক্ষা',
                '.category_item h3:eq(1)': 'চিকিৎসা সহায়তা',
                '.category_item h3:eq(2)': 'পরিবেশ',
                '.category_item h3:eq(3)': 'স্বাস্থ্যকর খাবার',
                '.category_item h3:eq(4)': 'আর্থিক সহায়তা',
                '.category_item h3:eq(5)': 'সচেতনতা',
                '.category_item h3:eq(6)': 'বয়স্কদের যত্ন',
            ...
            buttons: {
                ...
                '.ai_help_options button[data-ai-help="donate"]': 'দান',
        ...
        hi: {
            text: {
                ...
                '.category_item h3:eq(0)': 'शिक्षा',
                '.category_item h3:eq(1)': 'चिकित्सा मदद',
                '.category_item h3:eq(2)': 'पर्यावरण',
                '.category_item h3:eq(3)': 'स्वस्थ भोजन',
                '.category_item h3:eq(4)': 'आर्थिक सहायता',
                '.category_item h3:eq(5)': 'जागरूकता',
                '.category_item h3:eq(6)': 'बुजुर्ग देखभाल',
            ...
            buttons: {
                ...
                '.ai_help_options button[data-ai-help="donate"]': 'दान',
